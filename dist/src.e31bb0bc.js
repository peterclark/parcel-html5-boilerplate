...
/******/
{
  ...
  function srcBookingImba(module, exports, __webpack_require__) {
    eval("function iter$(a){ return a ? (a.toArray ? a.toArray() : a) : []; };\nvar Imba = __webpack_require__(/*! imba */ \"./node_modules/imba/imba.imba\"), _2 = Imba.createTagList, _1 = Imba.createElement;\nvar Booking = Imba.defineTag('Booking', function(tag){\n\t\n\tWEDDING = [\n\t\t{id: 1,name: 'Prelude',price: 300.00},\n\t\t{id: 2,name: 'Marches',price: 300.00},\n\t\t{id: 3,name: 'Ceremony',price: 300.00},\n\t\t{id: 4,name: 'Prelude & Marches',price: 400.00},\n\t\t{id: 5,name: 'Prelude & Ceremony',price: 400.00},\n\t\t{id: 6,name: 'Marches & Ceremony',price: 400.00},\n\t\t{id: 7,name: 'Prelude, Marches & Ceremony',price: 450.00}\n\t];\n\t\n\tRECEPTION = [\n\t\t{id: 8,name: '1 Hour Reception',price: 300.00},\n\t\t{id: 9,name: '2 Hour Reception',price: 500.00},\n\t\t{id: 10,name: '3 Hour Reception',price: 625.00},\n\t\t{id: 11,name: '4 Hour Reception',price: 775.00}\n\t];\n\t\n\tBOTH = [\n\t\t{id: 12,name: 'Wedding Service & 1 Hour Reception',price: 600.00},\n\t\t{id: 13,name: 'Wedding Service & 2 Hour Reception',price: 750.00},\n\t\t{id: 14,name: 'Wedding Service & 3 Hour Reception',price: 850.00}\n\t];\n\t\n\ttag.prototype.services = function (){\n\t\treturn WEDDING.concat(RECEPTION,BOTH);\n\t};\n\t\n\ttag.prototype.render = function (){\n\t\tvar $ = this.$, self = this, t0, t1;\n\t\treturn self.$open(0).setChildren(\n\t\t\t$[0] || _1('div',$,0,self).flag('ui').flag('vertical').flag('stripe').flag('segment').setId('booking').setContent(\n\t\t\t\t$[1] || _1('div',$,1,0).flag('ui').flag('container').setContent([\n\t\t\t\t\t_1('h3',$,2,1).flag('ui').flag('horizontal').flag('divider').flag('header').setContent([\n\t\t\t\t\t\t$[3] || _1('i',$,3,2).flag('calendar').flag('icon'),\n\t\t\t\t\t\t\"Contact\"\n\t\t\t\t\t],2),\n\t\t\t\t\t\n\t\t\t\t\t_1('form',$,4,1).flag('ui').flag('large').flag('form').setMethod('post').setName('booking').setContent([\n\t\t\t\t\t\t_1('input',$,5,4).setType('hidden').setName('form-name').setValue('booking',1),\n\t\t\t\t\t\t_1('div',$,6,4).flag('three').flag('fields').setContent([\n\t\t\t\t\t\t\tt0 = (t0=_1('div',$,7,6)).flag('required').flag('full_name').flag('field').setContent([\n\t\t\t\t\t\t\t\t_1('label',$,8,7).setText(\"Your Full Name\"),\n\t\t\t\t\t\t\t\tself._fullName = self._fullName||_1('input',t0).flag('fullName').setId('fullName').setType('text').setName('full_name').setMaxlength('30').setValue('',1)\n\t\t\t\t\t\t\t],2),\n\t\t\t\t\t\t\tt1 = (t1=_1('div',$,9,6)).flag('required').flag('mobile').flag('field').setContent([\n\t\t\t\t\t\t\t\t_1('label',$,10,9).setText(\"Mobile phone\"),\n\t\t\t\t\t\t\t\tself._to = self._to||_1('input',t1).flag('to').setId('mobile').setType('tel').setName('mobile').setMaxlength('10').setValue('',1)\n\t\t\t\t\t\t\t],2),\n\t\t\t\t\t\t\t_1('div',$,11,6).flag('required').flag('event_date').flag('field').setContent([\n\t\t\t\t\t\t\t\t_1('label',$,12,11).setText(\"Date of Event\"),\n\t\t\t\t\t\t\t\t_1('input',$,13,11).flag('ui').setId('eventDate').setType('text').setName('event_date').setValue('',1)\n\t\t\t\t\t\t\t],2)\n\t\t\t\t\t\t],2),\n\t\t\t\t\t\t_1('div',$,14,4).flag('two').flag('fields').setContent([\n\t\t\t\t\t\t\t_1('div',$,15,14).flag('required').flag('event_location').flag('field').setContent([\n\t\t\t\t\t\t\t\t_1('label',$,16,15).setText(\"Event Location\"),\n\t\t\t\t\t\t\t\t_1('input',$,17,15).setId('eventLocation').setType('text').setName('event_location').setMaxlength('100').setValue('',1)\n\t\t\t\t\t\t\t],2),\n\t\t\t\t\t\t\t_1('div',$,18,14).flag('required').flag('services').flag('field').setContent([\n\t\t\t\t\t\t\t\t_1('label',$,19,18).setText(\"Services\"),\n\t\t\t\t\t\t\t\t_1('select',$,20,18).flag('ui').flag('dropdown').setId('services').setMultiple('multiple').setName('service_ids')\n\t\t\t\t\t\t\t],2)\n\t\t\t\t\t\t],2),\n\t\t\t\t\t\t_1('div',$,22,4).flag('ui').flag('segment').setContent(\n\t\t\t\t\t\t\t$[23] || _1('div',$,23,22).flag('required').flag('inline').flag('contract_accepted').flag('field').setContent(\n\t\t\t\t\t\t\t\t$[24] || _1('div',$,24,23).flag('ui').flag('toggle').flag('checkbox').setContent([\n\t\t\t\t\t\t\t\t\t_1('input',$,25,24).flag('hidden').setId('contractAccepted').setType('checkbox').setName('contract_accepted').setChecked(''),\n\t\t\t\t\t\t\t\t\t_1('label',$,26,24).setFor(\"contract_accepted\").setContent([\n\t\t\t\t\t\t\t\t\t\t_1('span',$,27,26).setText(\"I have read and agree to the terms of the\"),\n\t\t\t\t\t\t\t\t\t\t_1('a',$,28,26).setHref('fluteviolin_contract.pdf').setTarget('_blank').setText(\" contract\")\n\t\t\t\t\t\t\t\t\t],2)\n\t\t\t\t\t\t\t\t],2)\n\t\t\t\t\t\t\t,2)\n\t\t\t\t\t\t,2),\n\t\t\t\t\t\t\n\t\t\t\t\t\t_1('div',$,29,4).flag('ui').flag('three').flag('column').flag('stackable').flag('centered').flag('grid').setContent(\n\t\t\t\t\t\t\t$[30] || _1('div',$,30,29).flag('column').setContent(\n\t\t\t\t\t\t\t\t$[31] || _1('button',$,31,30).flag('massive').flag('fluid').flag('ui').flag('primary').flag('button').setId('bookNow').setType('submit').setText(\"Contact\")\n\t\t\t\t\t\t\t,2)\n\t\t\t\t\t\t,2)\n\t\t\t\t\t],2)\n\t\t\t\t],2)\n\t\t\t,2)\n\t\t,2).synced((\n\t\t\t$[4].end((\n\t\t\t\t$[5].end(),\n\t\t\t\tself._fullName.end(),\n\t\t\t\tself._to.end(),\n\t\t\t\t$[13].end(),\n\t\t\t\t$[17].end(),\n\t\t\t\t$[20].setContent(\n\t\t\t\t\t(function tagLoop($0) {\n\t\t\t\t\t\tfor (let i = 0, items = iter$(self.services()), len = $0.taglen = items.length, service; i < len; i++) {\n\t\t\t\t\t\t\tservice = items[i];\n\t\t\t\t\t\t\t($0[i] || _1('option',$0,i)).setValue((\"\" + (service.id)),1).setText(\"$\" + (service.price) + \" - \" + (service.name)).end();\n\t\t\t\t\t\t};return $0;\n\t\t\t\t\t})($[21] || _2($,21,$[20]))\n\t\t\t\t,4).end(),\n\t\t\t\t$[25].end(),\n\t\t\t\t$[26].end((\n\t\t\t\t\t$[28].end()\n\t\t\t\t,true)),\n\t\t\t\t$[31].end()\n\t\t\t,true))\n\t\t,true));\n\t};\n})\nexports.Booking = Booking;\n\n\n//# sourceURL=webpack:///./src/booking.imba?");
    /***/
  },
  ...
  function _(module, exports, __webpack_require__) {
    eval("__webpack_require__(/*! /Users/peter/Projects/parcel-starter/src/about.imba */\"./src/about.imba\");\n__webpack_require__(/*! /Users/peter/Projects/parcel-starter/src/booking.imba */\"./src/booking.imba\");\n__webpack_require__(/*! /Users/peter/Projects/parcel-starter/src/index.imba */\"./src/index.imba\");\n__webpack_require__(/*! /Users/peter/Projects/parcel-starter/src/listen.imba */\"./src/listen.imba\");\n__webpack_require__(/*! /Users/peter/Projects/parcel-starter/src/masthead.imba */\"./src/masthead.imba\");\nmodule.exports = __webpack_require__(/*! /Users/peter/Projects/parcel-starter/src/prices.imba */\"./src/prices.imba\");\n\n\n//# sourceURL=webpack:///multi_./src/about.imba_./src/booking.imba_./src/index.imba_./src/listen.imba_./src/masthead.imba_./src/prices.imba?");
    /***/
  }
  /******/
